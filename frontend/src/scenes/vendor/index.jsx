...
const Vendor = () => {
  ...
  const handleFilter = (payload) => {
    const filteredCategories = vendors.filter((vendor) => {
      const nameMatches = payload.name
        ? vendor.name.toLowerCase().includes(payload.name.toLowerCase())
        : true

      return nameMatches
    })

    setFilteredVendors(filteredCategories)
  }
