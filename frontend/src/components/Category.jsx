          ...
          <Card className="p-4 shadow-sm">
            <Card.Body>
              <div className="d-flex justify-content-between align-items-center mb-4">
                <Card.Title><b>Categories</b></Card.Title>
                ...
                <tbody>
                  {currentCategories.map((category) => (
                    <tr key={category.id}>
                      ...
                      <td>{category.name}</td>
                      <td>
                        <Button variant="warning" onClick={() => handleEdit(category)} className="me-2">Edit</Button>
              ...
              <Pagination className="justify-content-center">
                ...
                <Pagination.Next onClick={nextPage} disabled={currentPage === Math.ceil(categories.length / categoriesPerPage)} />
              </Pagination>
            </Card.Body>
          </Card>
        </Col>
