      ...
      <Navbar bg="dark" variant="dark" expand="lg" className="navbar-custom">
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <Nav>
              <NavDropdown title="Admin/User" id="basic-nav-dropdown" show={menuOpen} onClick={handleMenuToggle} align="end">
                <NavDropdown.Item href="#action/3.1">Edit Profile</NavDropdown.Item>
                <NavDropdown.Item href="#action/3.2">Manage Stocks</NavDropdown.Item>
                <NavDropdown.Item href="#action/3.3">Manage Sales</NavDropdown.Item>
                <NavDropdown.Item href="#action/3.4">Manage Inventory</NavDropdown.Item>
                <NavDropdown.Divider />
